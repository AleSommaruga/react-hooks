...
I revised the useState hook of React: it returns a pair (variable, setter of the variable): an automatic re-render of the page is triggered when the setter is called. You can also add properties (props) to your component (e.g., initialValue) that can be passed as arguments in js and used to customize the component.
